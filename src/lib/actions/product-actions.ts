...
// skills/business-rules.md, punkt 9 (dubblettkontroll): varna men blockera inte.
// Vi kollar samma streckkod eller ett namn som innehåller/innehålls i det nya namnet.
async function findPossibleDuplicates(name: string, barcode: string | null) {
